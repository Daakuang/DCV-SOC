function net = createNN2(neurons_per_layer,par)
% create a CV NN
% nu is the dim of uk
...
for i = 1:num_layers - 1
    ...
    if i< num_layers - 1
        outLayer = tanh(W*outLayer+b); % Replace with desired activation function
    else
...
nn = Function('nn', {Xi,theta}, {outLayer});
